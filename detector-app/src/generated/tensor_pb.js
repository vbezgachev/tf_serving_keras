...
var resource_handle_pb = require('./resource_handle_pb.js');
...
proto.tensorflow.TensorProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    halfValList: jspb.Message.getRepeatedField(msg, 13),
    ...
    intValList: jspb.Message.getRepeatedField(msg, 7),
    stringValList: msg.getStringValList_asB64(),
    scomplexValList: jspb.Message.getRepeatedFloatingPointField(msg, 9),
    int64ValList: jspb.Message.getRepeatedField(msg, 10),
    boolValList: jspb.Message.getRepeatedField(msg, 11),
    ...
    resource_handle_pb.ResourceHandleProto.toObject, includeInstance),
    ...
    uint32ValList: jspb.Message.getRepeatedField(msg, 16),
    uint64ValList: jspb.Message.getRepeatedField(msg, 17)
  };
...
proto.tensorflow.TensorProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 12:
      ...
      break;
    case 14:
      var value = new resource_handle_pb.ResourceHandleProto;
      reader.readMessage(value,resource_handle_pb.ResourceHandleProto.deserializeBinaryFromReader);
...
proto.tensorflow.TensorProto.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      14,
      f,
      resource_handle_pb.ResourceHandleProto.serializeBinaryToWriter
    );
  }
...
proto.tensorflow.TensorProto.prototype.getBoolValList = function() {
  return /** @type {!Array.<boolean>} */ (jspb.Message.getRepeatedField(this, 11));
};
...
proto.tensorflow.TensorProto.prototype.getResourceHandleValList = function() {
  return /** @type{!Array.<!proto.tensorflow.ResourceHandleProto>} */ (
    jspb.Message.getRepeatedWrapperField(this, resource_handle_pb.ResourceHandleProto, 14));
};
