...
goog.exportSymbol('proto.tensorflow.serving.Int64Value', null, global);
 ...
 * @constructor
 */
proto.tensorflow.serving.Int64Value = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.tensorflow.serving.Int64Value, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.tensorflow.serving.Int64Value.displayName = 'proto.tensorflow.serving.Int64Value';
}
 ...
 * @return {!Object}
 */
proto.tensorflow.serving.Int64Value.prototype.toObject = function(opt_includeInstance) {
  return proto.tensorflow.serving.Int64Value.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.tensorflow.serving.Int64Value} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tensorflow.serving.Int64Value.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.tensorflow.serving.Int64Value}
 */
proto.tensorflow.serving.Int64Value.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.tensorflow.serving.Int64Value;
  return proto.tensorflow.serving.Int64Value.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.tensorflow.serving.Int64Value} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.tensorflow.serving.Int64Value}
 */
proto.tensorflow.serving.Int64Value.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.tensorflow.serving.Int64Value.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.tensorflow.serving.Int64Value.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.tensorflow.serving.Int64Value} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.tensorflow.serving.Int64Value.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.tensorflow.serving.Int64Value.prototype.getValue = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.tensorflow.serving.Int64Value.prototype.setValue = function(value) {
...
proto.tensorflow.serving.ModelSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    version: (f = msg.getVersion()) && proto.tensorflow.serving.Int64Value.toObject(includeInstance, f),
...
proto.tensorflow.serving.ModelSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.tensorflow.serving.Int64Value;
      reader.readMessage(value,proto.tensorflow.serving.Int64Value.deserializeBinaryFromReader);
...
proto.tensorflow.serving.ModelSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.tensorflow.serving.Int64Value.serializeBinaryToWriter
    );
  }
...
/**
 * optional Int64Value version = 2;
 * @return {?proto.tensorflow.serving.Int64Value}
 */
proto.tensorflow.serving.ModelSpec.prototype.getVersion = function() {
  return /** @type{?proto.tensorflow.serving.Int64Value} */ (
    jspb.Message.getWrapperField(this, proto.tensorflow.serving.Int64Value, 2));
};


/** @param {?proto.tensorflow.serving.Int64Value|undefined} value */
